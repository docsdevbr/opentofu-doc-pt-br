...
[the CLI configuration](../cli/config/config-file.mdx).
...
[the CLI config Credentials Helpers section](../cli/config/config-file.mdx#credentials-helpers).
...
[default plugin search locations](../cli/config/config-file.mdx#provider-installation).
...
[`credentials` blocks in the CLI configuration](../cli/config/config-file.mdx#credentials).
...
one of the [default plugin search locations](../cli/config/config-file.mdx#provider-installation).
