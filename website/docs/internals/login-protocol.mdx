...
[`tofu login`](../cli/commands/login.mdx).  The information below is for
...
any [OpenTofu-native services](../internals/remote-service-discovery.mdx),
such as an OpenTofu module registry.

First, OpenTofu uses
[remote service discovery](../internals/remote-service-discovery.mdx) to
