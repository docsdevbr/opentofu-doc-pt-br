...
is created. This can be used to run a configuration management tool, bootstrap
into a cluster, etc. To invoke a local process, see the `local-exec`
[provisioner](../../../language/resources/provisioners/local-exec.mdx) instead. The `remote-exec`
provisioner requires a [connection](../../../language/resources/provisioners/connection.mdx)
...
[file provisioner](../../../language/resources/provisioners/file.mdx)
