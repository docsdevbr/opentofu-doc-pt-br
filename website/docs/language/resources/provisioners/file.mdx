...
description: >-
  ...
  executing OpenTofu to the newly created resource. The `file` provisioner
...
supports both `ssh` and `winrm` type [connections](../../../language/resources/provisioners/connection.mdx).
