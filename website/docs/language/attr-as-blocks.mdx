...
- Use OpenTofu's [JSON syntax](./syntax/json.mdx) with this
  type of resource.
...
[argument syntax and nested block syntax](syntax/configuration.mdx#arguments-and-blocks)
within blocks:
...
[`dynamic` blocks](expressions/dynamic-blocks.mdx)
...
the [JSON expression mapping](syntax/json.mdx#expression-mapping)
