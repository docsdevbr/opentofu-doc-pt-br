...
Refer to [Custom Condition Checks](custom-conditions.mdx#input-variable-validation) for details.
...
use [`tostring`](../../language/functions/tostring.mdx) to explicitly convert a number to
a string.
