...
A `dynamic` block acts much like a [`for` expression](for.mdx), but produces
...
[`flatten`](../../language/functions/flatten.mdx)
and
[`setproduct`](../../language/functions/setproduct.mdx)
functions.
...
tradeoff, see [When to Write a Module](../../language/modules/develop/index.mdx#when-to-write-a-module)
and [Module Composition](../../language/modules/develop/composition.mdx).
