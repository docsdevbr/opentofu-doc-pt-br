...
[custom condition checks](../../language/expressions/custom-conditions.mdx) that
...
* [`timeadd`](../../language/functions/timeadd.mdx) can perform arithmetic on timestamps by adding or removing a specified duration.
