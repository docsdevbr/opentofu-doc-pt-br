...
* [`filesha256`](../../language/functions/filesha256.mdx) calculates the same hash from
  the contents of a file rather than from a string value.
* [`base64sha256`](../../language/functions/base64sha256.mdx) calculates the same hash but returns
