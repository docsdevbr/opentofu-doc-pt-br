...
All of the arguments must be of the same type. OpenTofu will try to
...
OpenTofu attempts to select a result type that all of the arguments can
...
* [`coalescelist`](../../language/functions/coalescelist.mdx) performs a similar operation with
