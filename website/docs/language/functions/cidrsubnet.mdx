...
Unlike the related function [`cidrsubnets`](../../language/functions/cidrsubnets.mdx), `cidrsubnet`
...
While [`cidrhost`](../../language/functions/cidrhost.mdx) allows calculating single host IP addresses,
...
[`cidrhost`](../../language/functions/cidrhost.mdx) function to calculate those host addresses by
...
* [`cidrhost`](../../language/functions/cidrhost.mdx) calculates the IP address for a single host
  within a given network address prefix.
* [`cidrnetmask`](../../language/functions/cidrnetmask.mdx) converts an IPv4 network prefix in CIDR
  notation into netmask notation.
* [`cidrsubnets`](../../language/functions/cidrsubnets.mdx) can allocate multiple consecutive
