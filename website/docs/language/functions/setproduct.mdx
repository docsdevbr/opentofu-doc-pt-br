...
OpenTofu will attempt to convert to the most general type, or produce an
...
- [`flatten`](../../language/functions/flatten.mdx) is useful for flattening hierarchical data
...
- [`setunion`](../../language/functions/setunion.mdx) computes the _union_ of multiple
  sets.
