...
- [`format`](../../language/functions/format.mdx) is a more general formatting function for arbitrary
  data.
- [`timestamp`](../../language/functions/timestamp.mdx) returns the current date and time in a format
