...
To learn how to _use_ modules, see [the Modules configuration section](../../../language/modules/index.mdx).
...
[configuration language](../../../language/index.mdx) concepts we use in root modules.
Most commonly, modules use:

* [Input variables](../../../language/values/variables.mdx) to accept values from
  the calling module.
* [Output values](../../../language/values/outputs.mdx) to return results to the
  calling module, which it can then use to populate arguments elsewhere.
* [Resources](../../../language/resources/index.mdx) to define one or more
...
files inside just as you would do for a root module. OpenTofu can load modules
...
keeping the module tree relatively flat and using [module composition](../../../language/modules/develop/composition.mdx)
...
out into a module, but over-using modules can make your overall OpenTofu
...
You can include [refactoring blocks](../../../language/modules/develop/refactoring.mdx) to record how resource
names and module structure have changed from previous module versions.
OpenTofu uses that information during planning to reinterpret existing objects
